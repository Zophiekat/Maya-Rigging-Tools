...
def connect_node_attributes_from_list():
    print("Function: connect_node_attributes_from_list")
    connect_node_attribute("Custom_Control__CurveShape__001", "controlPoints", "controlPoints", 1)
    connect_node_attribute("Custom_Control__CurveShape__001", "local", "create", 1)
        

connect_node_attributes_from_list()
